  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Monitor blockchain transactions and crypto assets</p>
      </div>
      ...
      <Card className="p-8 text-center">
        <div className="mx-auto max-w-sm">
          ...
          <p className="text-muted-foreground">
            The Blockchain Explorer section is currently being developed.
          </p>
        </div>
      </Card>
      ...
      <Card className="border border-dashed border-muted p-4">
        <p className="text-center text-sm text-muted-foreground">
          Check back soon for blockchain API integrations and crypto transaction monitoring.
        </p>
      </Card>
    </div>
  )
