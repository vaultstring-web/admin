...
import { Search, Filter, ChevronDown, ChevronUp, User, ArrowUpDown } from 'lucide-react';
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="primary" leftIcon={<User className="w-4 h-4"/>}>Add Customer</Button>
        </div>
      </div>
                      ...
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10 relative">
                          <Image
                            ...
                            fill
                            className="rounded-full object-cover border border-neutral-light-border dark:border-neutral-dark-border"
                            sizes="40px"
                          />
                        </div>
                        <div className="ml-4">
